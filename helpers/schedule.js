...
class ScheduleTableGenerator {
  ...
  // Takes two arguments: mountainindex (index of the mountain schedule data to use)
  // and container (DOM element where the table will be appended).
  ...
  generateTables() {
    for (let i = 0; i < this.mountainScheduleData.length; i += 1) {
