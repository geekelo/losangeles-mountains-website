...
// both for mobile and desktop views. It creates the necessary
// HTML elements, adds images to the carousels,
...
class CarouselHandler {
  ...
  // For each image, it creates a div element with the class 'carousel-item'
  // and adds an img element with the corresponding src and alt.
  ...
  // Creates a div element for each set of 4 images,
  // adding the class 'carousel-item' and marking the first as active.
  ...
  addImagesToDesktopCarousel() {
    ...
    for (let i = 0; i < this.carouselImages.length / 4; i += 1) {
      ...
      for (let j = i * 4; j < i * 4 + 4 && j < this.carouselImages.length; j += 1) {
